/* generated from /home/b/test/sel4test/kernel/libsel4/sel4_arch_include/aarch64/sel4/sel4_arch/types.bf */
...
LIBSEL4_INLINE_FUNC seL4_Fault_t CONST
seL4_Fault_DebugException_new(seL4_Uint64 FaultIP, seL4_Uint64 ExceptionReason, seL4_Uint64 TriggerAddress, seL4_Uint64 BreakpointNumber) {
    seL4_Fault_t seL4_Fault;

    /* fail if user has passed bits that we will override */  
    seL4_DebugAssert(((seL4_Uint64)seL4_Fault_DebugException & ~0xfull) == ((0 && ((seL4_Uint64)seL4_Fault_DebugException & (1ull << 63))) ? 0x0 : 0));

    seL4_Fault.words[0] = 0
        | ((seL4_Uint64)seL4_Fault_DebugException & 0xfull) << 0;
    seL4_Fault.words[1] = 0
        | BreakpointNumber << 0;
    seL4_Fault.words[2] = 0
        | TriggerAddress << 0;
...
LIBSEL4_INLINE_FUNC void
seL4_Fault_DebugException_ptr_new(seL4_Fault_t *seL4_Fault_ptr, seL4_Uint64 FaultIP, seL4_Uint64 ExceptionReason, seL4_Uint64 TriggerAddress, seL4_Uint64 BreakpointNumber) {
    /* fail if user has passed bits that we will override */  
    seL4_DebugAssert(((seL4_Uint64)seL4_Fault_DebugException & ~0xfull) == ((0 && ((seL4_Uint64)seL4_Fault_DebugException & (1ull << 63))) ? 0x0 : 0));
...
LIBSEL4_INLINE_FUNC seL4_Uint64 CONST
seL4_Fault_DebugException_get_FaultIP(seL4_Fault_t seL4_Fault) {
    seL4_Uint64 ret;
    seL4_DebugAssert(((seL4_Fault.words[0] >> 0) & 0xf) ==
...
LIBSEL4_INLINE_FUNC seL4_Fault_t CONST
seL4_Fault_DebugException_set_FaultIP(seL4_Fault_t seL4_Fault, seL4_Uint64 v64) {
    seL4_DebugAssert(((seL4_Fault.words[0] >> 0) & 0xf) ==
           seL4_Fault_DebugException);
    /* fail if user has passed bits that we will override */
    seL4_DebugAssert((((~0xffffffffffffffffull >> 0 ) | 0x0) & v64) == ((0 && (v64 & (1ull << (63)))) ? 0x0 : 0));
...
LIBSEL4_INLINE_FUNC seL4_Uint64 PURE
seL4_Fault_DebugException_ptr_get_FaultIP(seL4_Fault_t *seL4_Fault_ptr) {
    seL4_Uint64 ret;
    seL4_DebugAssert(((seL4_Fault_ptr->words[0] >> 0) & 0xf) ==
           seL4_Fault_DebugException);
...
LIBSEL4_INLINE_FUNC void
seL4_Fault_DebugException_ptr_set_FaultIP(seL4_Fault_t *seL4_Fault_ptr,
                                      seL4_Uint64 v64) {
    seL4_DebugAssert(((seL4_Fault_ptr->words[0] >> 0) & 0xf) ==
           seL4_Fault_DebugException);
...
LIBSEL4_INLINE_FUNC seL4_Fault_t CONST
seL4_Fault_DebugException_set_ExceptionReason(seL4_Fault_t seL4_Fault, seL4_Uint64 v64) {
    seL4_DebugAssert(((seL4_Fault.words[0] >> 0) & 0xf) ==
           seL4_Fault_DebugException);
    /* fail if user has passed bits that we will override */
    seL4_DebugAssert((((~0xffffffffffffffffull >> 0 ) | 0x0) & v64) == ((0 && (v64 & (1ull << (63)))) ? 0x0 : 0));
...
LIBSEL4_INLINE_FUNC seL4_Uint64 PURE
seL4_Fault_DebugException_ptr_get_ExceptionReason(seL4_Fault_t *seL4_Fault_ptr) {
    seL4_Uint64 ret;
    seL4_DebugAssert(((seL4_Fault_ptr->words[0] >> 0) & 0xf) ==
           seL4_Fault_DebugException);
...
LIBSEL4_INLINE_FUNC void
seL4_Fault_DebugException_ptr_set_ExceptionReason(seL4_Fault_t *seL4_Fault_ptr,
                                      seL4_Uint64 v64) {
    seL4_DebugAssert(((seL4_Fault_ptr->words[0] >> 0) & 0xf) ==
           seL4_Fault_DebugException);
...
LIBSEL4_INLINE_FUNC seL4_Uint64 CONST
seL4_Fault_DebugException_get_TriggerAddress(seL4_Fault_t seL4_Fault) {
    seL4_Uint64 ret;
    seL4_DebugAssert(((seL4_Fault.words[0] >> 0) & 0xf) ==
           seL4_Fault_DebugException);
...
LIBSEL4_INLINE_FUNC seL4_Fault_t CONST
seL4_Fault_DebugException_set_TriggerAddress(seL4_Fault_t seL4_Fault, seL4_Uint64 v64) {
    seL4_DebugAssert(((seL4_Fault.words[0] >> 0) & 0xf) ==
           seL4_Fault_DebugException);
    /* fail if user has passed bits that we will override */
    seL4_DebugAssert((((~0xffffffffffffffffull >> 0 ) | 0x0) & v64) == ((0 && (v64 & (1ull << (63)))) ? 0x0 : 0));
...
LIBSEL4_INLINE_FUNC seL4_Uint64 PURE
seL4_Fault_DebugException_ptr_get_TriggerAddress(seL4_Fault_t *seL4_Fault_ptr) {
    seL4_Uint64 ret;
    seL4_DebugAssert(((seL4_Fault_ptr->words[0] >> 0) & 0xf) ==
           seL4_Fault_DebugException);
...
LIBSEL4_INLINE_FUNC void
seL4_Fault_DebugException_ptr_set_TriggerAddress(seL4_Fault_t *seL4_Fault_ptr,
                                      seL4_Uint64 v64) {
    seL4_DebugAssert(((seL4_Fault_ptr->words[0] >> 0) & 0xf) ==
           seL4_Fault_DebugException);
...
LIBSEL4_INLINE_FUNC seL4_Fault_t CONST
seL4_Fault_DebugException_set_BreakpointNumber(seL4_Fault_t seL4_Fault, seL4_Uint64 v64) {
    seL4_DebugAssert(((seL4_Fault.words[0] >> 0) & 0xf) ==
           seL4_Fault_DebugException);
    /* fail if user has passed bits that we will override */
    seL4_DebugAssert((((~0xffffffffffffffffull >> 0 ) | 0x0) & v64) == ((0 && (v64 & (1ull << (63)))) ? 0x0 : 0));
...
LIBSEL4_INLINE_FUNC seL4_Uint64 PURE
seL4_Fault_DebugException_ptr_get_BreakpointNumber(seL4_Fault_t *seL4_Fault_ptr) {
    seL4_Uint64 ret;
    seL4_DebugAssert(((seL4_Fault_ptr->words[0] >> 0) & 0xf) ==
           seL4_Fault_DebugException);
...
LIBSEL4_INLINE_FUNC void
seL4_Fault_DebugException_ptr_set_BreakpointNumber(seL4_Fault_t *seL4_Fault_ptr,
                                      seL4_Uint64 v64) {
    seL4_DebugAssert(((seL4_Fault_ptr->words[0] >> 0) & 0xf) ==
           seL4_Fault_DebugException);
