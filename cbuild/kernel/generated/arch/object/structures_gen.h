...
static inline dbg_bcr_t CONST
dbg_bcr_set_breakpointType(dbg_bcr_t dbg_bcr, uint64_t v64) {
    /* fail if user has passed bits that we will override */
    assert((((~0xf00000ull >> 20 ) | 0x0) & v64) == ((0 && (v64 & (1ull << (47)))) ? 0x0 : 0));
...
dbg_bcr_set_lbn(dbg_bcr_t dbg_bcr, uint64_t v64) {
    /* fail if user has passed bits that we will override */
    assert((((~0xf0000ull >> 16 ) | 0x0) & v64) == ((0 && (v64 & (1ull << (47)))) ? 0x0 : 0));
...
dbg_bcr_set_ssc(dbg_bcr_t dbg_bcr, uint64_t v64) {
    /* fail if user has passed bits that we will override */
    assert((((~0xc000ull >> 14 ) | 0x0) & v64) == ((0 && (v64 & (1ull << (47)))) ? 0x0 : 0));
...
dbg_bcr_set_hmc(dbg_bcr_t dbg_bcr, uint64_t v64) {
    /* fail if user has passed bits that we will override */
    assert((((~0x2000ull >> 13 ) | 0x0) & v64) == ((0 && (v64 & (1ull << (47)))) ? 0x0 : 0));
...
dbg_bcr_set_bas(dbg_bcr_t dbg_bcr, uint64_t v64) {
    /* fail if user has passed bits that we will override */
    assert((((~0x1e0ull >> 5 ) | 0x0) & v64) == ((0 && (v64 & (1ull << (47)))) ? 0x0 : 0));
...
dbg_bcr_set_pmc(dbg_bcr_t dbg_bcr, uint64_t v64) {
    /* fail if user has passed bits that we will override */
    assert((((~0x6ull >> 1 ) | 0x0) & v64) == ((0 && (v64 & (1ull << (47)))) ? 0x0 : 0));
...
static inline dbg_wcr_t CONST
dbg_wcr_set_addressMask(dbg_wcr_t dbg_wcr, uint64_t v64) {
    /* fail if user has passed bits that we will override */
    assert((((~0x1f000000ull >> 24 ) | 0x0) & v64) == ((0 && (v64 & (1ull << (47)))) ? 0x0 : 0));
...
dbg_wcr_set_watchpointType(dbg_wcr_t dbg_wcr, uint64_t v64) {
    /* fail if user has passed bits that we will override */
    assert((((~0x100000ull >> 20 ) | 0x0) & v64) == ((0 && (v64 & (1ull << (47)))) ? 0x0 : 0));
...
dbg_wcr_set_bas(dbg_wcr_t dbg_wcr, uint64_t v64) {
    /* fail if user has passed bits that we will override */
    assert((((~0x1fe0ull >> 5 ) | 0x0) & v64) == ((0 && (v64 & (1ull << (47)))) ? 0x0 : 0));
...
dbg_wcr_set_lsc(dbg_wcr_t dbg_wcr, uint64_t v64) {
    /* fail if user has passed bits that we will override */
    assert((((~0x18ull >> 3 ) | 0x0) & v64) == ((0 && (v64 & (1ull << (47)))) ? 0x0 : 0));
...
pte_pte_page_get_AP(pte_t pte) {
    uint64_t ret;
    assert(((pte.words[0] >> 0) & 0x400000000000003) ==
           0x1ull);
...
seL4_Fault_DebugException_new(uint64_t breakpointAddress, uint64_t breakpointNumber, uint64_t exceptionReason) {
    ...
    /* fail if user has passed bits that we will override */  
    assert((breakpointNumber & ~0xfull) == ((0 && (breakpointNumber & (1ull << 47))) ? 0x0 : 0));  
    assert((exceptionReason & ~0xfull) == ((0 && (exceptionReason & (1ull << 47))) ? 0x0 : 0));  
    assert(((uint64_t)seL4_Fault_DebugException & ~0xfull) == ((0 && ((uint64_t)seL4_Fault_DebugException & (1ull << 47))) ? 0x0 : 0));
